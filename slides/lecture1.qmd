...
:::{.absolute bottom="0%" right="0%" width="200px" .fragment fragment-index=1 .fade-in-then-out}
...
:::{.absolute bottom="0%" right="0%" width="200px" .fragment fragment-index=2 .fade-in-then-out}
...
:::{.absolute bottom="0%" right="0%" width="200px" .fragment fragment-index=3 .fade-in-then-out}
![Köhler et al., Geophys. J. Int. 239:862–81](figures/tphasenet.jpeg)
:::

:::{.absolute bottom="0%" right="0%" width="200px" .fragment fragment-index=4 .fade-in-then-out}
...
:::{.absolute bottom="0%" right="0%" width="200px" .fragment fragment-index=5 .fade-in-then-out}
...
:::{.absolute right="0%" bottom="0%" width="400px"}
...
ML in earthquake seismology

![](https://www.annualreviews.org/docserver/fulltext/earth/51/1/ea510105.f2.gif)


:::{.absolute bottom="0%" right="0%" style="font-size: 0.7em" .color-text-muted}
[Mousavi, S. M., & Beroza, G. C. (2023). Machine learning in earthquake seismology. Annual Review of Earth and Planetary Sciences, 51(1), 105-129.](https://www.annualreviews.org/content/journals/10.1146/annurev-earth-071822-100323)
:::
