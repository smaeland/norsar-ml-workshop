...
## Interlude: Programming 👩🏼‍💻{.center background-color="#FBE9E7"}
...
The different deep learning libraries implement the same concepts, so if we know NumPy, the transition to `<new flashy DL library✨>` is easy.
...
![](figures/cat-picture.png){width="45%" fig-align="center"}

:::{style="font-size: 0.7em;"}
From F. Chollet: _Deep Learning with Python_
:::


## Layer _activations_

We can visualise what each filter does by looking at its _activation_ on the test image: The output after the convolution and applying the activation function.

Examples:

:::{layout-ncol=2}
![Layer 1, filter 4](figures/cat-layer1-channel4.png){width="400px"}

![Layer 1, filter 7](figures/cat-layer1-channel7.png){width="400px"}
:::
...
![](figures/cat-layer1-2.png){width="100%"}
...
![](figures/cat-layer3.png){width="100%"}
...
![](figures/cat-layer4.png){width="100%"}
...
Myklebust, E. B., & Köhler, A. (2024). [Deep learning models for regional phase detection on seismic stations in Northern Europe and the European Arctic.](https://academic.oup.com/gji/article/239/2/862/7740467) Geophysical Journal International, 239(2), 862-881.
